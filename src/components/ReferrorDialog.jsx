...
const ReferrorDialog = ({ isOpen, onClose, onSave, editingReferror }) => {
      ...
      <DialogContent className="bg-gradient-to-br from-gray-800 to-gray-900 border border-yellow-600/30 text-white max-w-md">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold text-yellow-400">
            {editingReferror ? 'Edit Referror' : 'Add New Referror'}
          </DialogTitle>
        </DialogHeader>
